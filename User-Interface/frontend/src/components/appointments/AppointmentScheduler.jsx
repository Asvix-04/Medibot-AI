  ...
  return (
    <div className={`max-w-6xl mx-auto p-4 ${darkMode ? 'text-white' : 'text-gray-900'}`}>
      <div className="mb-8">
        ...
        {/* Toggle buttons - Updated colors to violet */}
        ...
        {activeView === 'list' ? (
          <AppointmentList darkMode={darkMode} />
        ) : (
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex justify-end mt-6">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`px-4 py-2 rounded-lg text-sm font-medium bg-violet-600 text-white hover:bg-violet-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-500 ${
                ...
                <div className={`h-[500px] rounded-lg flex items-center justify-center ${
                  ...
                  {loading ? (
                    <div className="text-center">
                      <div className="inline-block animate-spin rounded-full h-8 w-8 border-4 border-t-violet-500 border-r-transparent border-b-violet-500 border-l-transparent"></div>
                ...
                <div className={`flex rounded-md overflow-hidden border ${
                  ...
                  <button
                    className={`flex-1 py-2 ${
                      darkMode ? 'bg-gray-700 hover:bg-violet-800/40' : 'bg-gray-50 hover:bg-violet-50'
                    }`}
