...
import medibot_logo from '../../assets/medibot_logo.jpg'; // Import the logo correctly
      ...
      {messages.length === 0 ? (
        <div className="flex flex-col items-center justify-center h-full py-12">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <div className="p-3 rounded-lg border border-gray-200 bg-white dark:bg-gray-800 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow cursor-pointer hover:border-purple-300 dark:hover:border-purple-700">
