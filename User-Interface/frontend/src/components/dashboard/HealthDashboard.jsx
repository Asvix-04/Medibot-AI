  ...
  return (
    <div className="max-w-6xl mx-auto p-4 mb-12">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Monitor your health metrics, medications, and upcoming appointments</p>
      </div>
      ...
      <div className="flex justify-center space-x-4">
        ...
        <button className="px-6 py-3 bg-white border border-indigo-600 text-indigo-600 rounded-lg hover:bg-indigo-50 transition-colors flex items-center">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
