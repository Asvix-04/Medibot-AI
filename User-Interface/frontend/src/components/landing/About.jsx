  ...
  const aboutFeatures = [
    {
      ...
      description: 'Analyze symptoms and get real-time health insights using AI-powered medical intelligence.',
      icon: (
    ...
    },
    {
      ...
      description: 'Never miss a dose. Schedule reminders, track your intake, and manage prescriptions effortlessly.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Get immediate answers to your health questions anytime, anywhere with our AI-powered health assistant.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'View your health metrics at a glance with customizable dashboards tailored to your specific needs.',
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section id="about" className="py-24" style={{ background: 'linear-gradient(to bottom, #121212 0%, #1a1a1a 100%)' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20 text-center">
          <p className="text-xl max-w-3xl mx-auto" style={{ color: '#d6d4d4' }}>
            Medibot combines medical expertise with cutting-edge AI technology to provide you with personalized healthcare guidance whenever you need it.
          </p>
          <div className="mt-8">
            <a 
              href="#features" 
