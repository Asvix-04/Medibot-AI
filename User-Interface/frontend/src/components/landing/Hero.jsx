        ...
        >
          <defs>
            <linearGradient id="gradient" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop
                offset="0%"
                style={{ stopColor: "#6b21a8", stopOpacity: 0.1 }}
              />
              <stop
                offset="100%"
                style={{ stopColor: "#3b0764", stopOpacity: 0.1 }}
              />
            </linearGradient>
          </defs>
          <path
          ...
          >
            <div className="text-center">
              ...
              <p
                ...
                style={{ opacity: "1", transform: "none" }}
              >
                Manage medications, track health metrics, schedule appointments,
                and receive personalized health insights—all in one secure
                platform.
              </p>
              <div className="mt-8 sm:mt-12 flex justify-center">
                ...
                >
                  <Link
                    to="/signup"
                    aria-label="Sign up and get started with Medibot"
                ...
                >
                  <Link
                    to="/chat"
                    aria-label="Try a demo of Medibot"
