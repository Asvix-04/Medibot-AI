          ...
          {steps.map((step, index) => (
            ...
            >
              ...
              <div className={`md:w-1/2 ${index % 2 === 1 ? 'md:pr-12' : 'md:pl-12'}`}>
                <div className="inline-block rounded-full bg-[#6366f1] bg-opacity-10 px-3 py-1 text-sm font-semibold mb-4" style={{ color: '#6366f1' }}>
                  Step {step.number}
                </div>
                <h3 className="text-2xl font-bold mb-4" style={{ color: '#818cf8' }}>
                  {step.title}
                </h3>
