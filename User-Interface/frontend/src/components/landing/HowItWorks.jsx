  ...
  const steps = [
    {
      ...
      description:
        "Sign up and complete your health profile with basic information to get personalized recommendations.",
      image: step1Image,
    },
    {
      number: "02",
      ...
      description:
        "Add your medications, record health metrics, and manage your appointments all in one place.",
      image: step2Image,
    },
    {
      number: "03",
      ...
      description:
        "Get AI-powered health insights, medication reminders, and appointment notifications.",
      image: step3Image,
    },
    {
      number: "04",
      ...
      description:
        "Use Medibot's recommendations to make informed health decisions and achieve your goals.",
      image: step4Image,
    },
  ];
          ...
          {steps.map((step, index) => (
            ...
            >
                ...
                <div className="bg-[#1a1a1a] p-2 rounded-xl shadow-md border border-[#2a2a2a]">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      e.target.src =
                        "https://via.placeholder.com/600x400?text=Step+" +
                        step.number;
                    }}
                  />
                </div>
              ...
              >
                <div
                  aria-hidden="true"
                  className="inline-block rounded-full text-purple-400 bg-opacity-10 px-3 py-1 text-sm font-semibold mb-4"
                >
                  Step {step.number}
                </div>
