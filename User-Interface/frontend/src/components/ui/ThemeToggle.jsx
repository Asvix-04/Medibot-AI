...
const ThemeToggle = ({ darkMode, toggleDarkMode }) => {
  return (
    <button
      ...
      className="flex items-center justify-center h-8 w-8 rounded-full bg-violet-100 hover:bg-violet-200 dark:bg-violet-900 dark:hover:bg-violet-800 transition-colors duration-200"
